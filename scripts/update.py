...
new_main = """      <main class="flex-1 bg-bg-light p-3 flex flex-col overflow-hidden">
          ...
          <div class="bg-white rounded-container shadow-[0_1px_3px_rgba(0,0,0,0.05)] flex-1 flex flex-col overflow-hidden">
            ...
            <div class="h-12 border-b border-bg-line flex items-center px-4 flex-shrink-0 justify-between">
              <div class="flex items-center h-full">
                <span class="text-[16px] font-semibold text-text-title">访问体验监测</span>
                <span class="w-[1px] h-4 bg-bg-line mx-4"></span>
                <div class="flex h-full items-center gap-8">
                  <div class="relative h-full flex items-center text-xs cursor-pointer transition-colors" :class="activeLeaf === 'm_0_0_0' ? 'text-brand font-semibold' : 'text-text hover:text-brand'" @click="toggleL4('m_0_0_0')">
                    总览
                    <span x-show="activeLeaf === 'm_0_0_0'" class="absolute bottom-0 left-0 right-0 h-[2px] bg-brand rounded-t-sm" x-cloak></span>
                  </div>
                  <div class="relative h-full flex items-center text-xs cursor-pointer transition-colors" :class="activeLeaf === 'm_0_0_1' ? 'text-brand font-semibold' : 'text-text hover:text-brand'" @click="toggleL4('m_0_0_1')">
                    运维告警
                    <span x-show="activeLeaf === 'm_0_0_1'" class="absolute bottom-0 left-0 right-0 h-[2px] bg-brand rounded-t-sm" x-cloak></span>
                  </div>
                  <div class="relative h-full flex items-center text-xs cursor-pointer transition-colors" :class="activeLeaf === 'm_0_0_2' ? 'text-brand font-semibold' : 'text-text hover:text-brand'" @click="toggleL4('m_0_0_2')">
                    监测配置
                    <span x-show="activeLeaf === 'm_0_0_2'" class="absolute bottom-0 left-0 right-0 h-[2px] bg-brand rounded-t-sm" x-cloak></span>
                  </div>
                </div>
              </div>
            ...
            <div class="flex-1 overflow-y-auto bg-bg-light">
              ...
              <!-- 总览页 (m_0_0_0) -->
              <div x-show="activeLeaf === 'm_0_0_0'" class="p-3 flex flex-col gap-3" x-cloak>
                ...
                <div class="grid grid-cols-4 gap-3 flex-shrink-0">
                  ...
                  <div class="bg-white border border-bg-line rounded-container p-4 flex flex-col gap-2 relative overflow-hidden">
                    ...
                    <div class="flex items-center gap-2 text-xs mt-2">
                      ...
                      <span class="text-text-mute flex items-center gap-1">较上周 <span class="text-success">↑ 2.4%</span></span>
                    </div>
                ...
                <div class="flex gap-3 h-[300px] flex-shrink-0">
                  ...
                  <div class="bg-white border border-bg-line rounded-container flex flex-col flex-[3]">
                    <div class="h-10 px-4 border-b border-bg-line flex items-center justify-between">
                      <span class="text-xs font-semibold text-text-title">体验健康度趋势</span>
                      <div class="flex items-center gap-2 bg-bg-light p-0.5 rounded-control border border-border">
                         <div class="px-3 py-1 text-xs rounded-[2px] cursor-pointer hover:bg-white transition-colors">近 24 小时</div>
                         <div class="px-3 py-1 text-xs bg-white shadow-sm rounded-[2px] cursor-pointer text-brand font-medium">近 7 天</div>
                         <div class="px-3 py-1 text-xs rounded-[2px] cursor-pointer hover:bg-white transition-colors">近 30 天</div>
                      </div>
                    </div>
